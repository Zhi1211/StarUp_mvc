            ...
            <div class="container col-lg-10" style=" display: flex; ">  
                ...
                <div class="prodInfo col-lg-5" >     
                    <div class="upper" style="margin: 10px 0px; padding: 20px; background-color: rgba(255, 255, 255, 0.767); border-radius: 5px; box-shadow: 1px 1px 3px black">
                        <label>商品名稱：</label>  
                        <form:input type="text" id="prodName" path="prodName" style="margin-bottom:15px" class="form:input-large"/> 
                        <br> 
                        <label>廠商名稱：</label>       
                        <form:input type="text" name="prodCompany" path="prodCompany" style="margin-bottom:15px"/>    
                        <br>                
                        <label>商品分類：</label>     
                        <form:input type="text" name="prodType" path="prodType" style="margin-bottom:15px"/>  
                        <br>                
                        <label>分類目錄：</label>     
                        <form:input type="text" name="prodCategory" path="prodCategory" style="margin-bottom:15px"/>  
                        <br> 
                        <label>售價：NT$ </label>    
                        <form:input type="number" name="prodPrice" path="prodPrice" style="margin-bottom:15px"/>   
						<br>
						<br>
                        <label>庫存：</label>    
                        <form:input type="number" name="prodStock" path="prodStock"/>   
                    </div>
                    <div class="lower" style=" margin: 10px 0px; padding: 20px 10px; background-color: rgba(255, 255, 255, 0.733); border-radius: 5px; box-shadow: 1px 1px 3px black">
	                    ...
	                    <form:textarea rows="5" cols="55" name="prodIntro" path="prodIntro"/>
                        <hr>                                    
                    </div>
